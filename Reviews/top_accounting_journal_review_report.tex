...
So “more politically competitive” is basically the opposite of a safe strongly red or strongly blue state.

In practical terms, that usually means one of these:

smaller vote-margin gaps between the two major parties,
lower one-party dominance,
or a higher polarization/competition index built from closer election outcomes.

In your draft, though, this phrase is a bit slippery because the underlying measure is not described fully consistently across sections. At different points, the paper seems to tie it to different election-based constructions. So a careful reader could understand the broad intuition, but still be unsure exactly what your empirical variable is.

That is why I’d recommend replacing the phrase with something more precise whenever possible, for example:

states with closer presidential elections
states with greater two-party electoral competition
states with higher electoral competitiveness
states where the two major parties receive more similar vote shares

And when reporting results, it is better to define it explicitly once, such as:

“More politically competitive states are those in which recent election outcomes show smaller gaps between Democratic and Republican vote shares.”

One more point: if your mechanism is really about belief heterogeneity or investor disagreement, “politically competitive” is not automatically the perfect phrase. Competitive can mean close elections, while polarization can mean strong partisan division. Those are related, but not identical. So the paper should be careful not to treat:

political competition,
political polarization, and
investor belief dispersion
